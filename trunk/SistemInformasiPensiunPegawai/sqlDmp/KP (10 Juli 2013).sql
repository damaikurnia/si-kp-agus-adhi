...
insert  into `pns`(`nip_baru`,`nip_lama`,`nama_pns`,`id_SuratCPNS`,`id_SuratPangkatTerakhir`,`id_SuratSPTKGTerakhir`,`id_SuratKarpeg`,`id_SuratNikah`,`id_SuratNIPBaru`,`id_Suratkk`,`jk`,`status`) values ('105314031001','105314031','AGUSTINUS DWI B.D','CPNS1','SPT1','-','-','-','-','-','PRIA','NIKAH'),('195210231979011003','130701386','Drs. MARIMIN','13125/C/2/796','823.4/72/2002','822.4/773/13','C. 0085821','327/40/1981','1531','0012999222','PRIA','NIKAH');
...
insert  into `s_nikah`(`id_SuratNikah`,`tanggal_nikah`,`nama_suami`,`nama_istri`,`tanggal_penyimpanan_surat`,`kode_operator`) values ('327/40/1981','1981-12-26','Marimin,BA','Widayati','2013-07-10','P');
...
CREATE TABLE `sk_cpns` (
  ...
  `gp_bulanan` varchar(3) DEFAULT NULL,
  `dari_gaji` varchar(100) DEFAULT NULL,
  ...
  `persetujuan_dr` varchar(200) DEFAULT NULL,
  `nmr_persetujuan` varchar(70) DEFAULT NULL,
  `tmt_persetujuan` date DEFAULT NULL,
  `tanggal_penyimpanan_surat` date DEFAULT NULL,
  `kode_operator` varchar(2) DEFAULT NULL,
...
insert  into `sk_cpns`(`id_SuratCPNS`,`tempat_surat`,`tanggal_surat`,`nama_pemilik`,`tempat_lahir`,`tanggal_lahir`,`partikelir`,`tmt_partikelir`,`Profesi`,`Sekolah`,`nip_lama`,`nip_baru`,`gp_bulanan`,`dari_gaji`,`masa_kerja_tahun`,`masa_kerja_bulan`,`golongan`,`berijazah`,`persetujuan_dr`,`nmr_persetujuan`,`tmt_persetujuan`,`tanggal_penyimpanan_surat`,`kode_operator`) values ('13125/C/2/796','Jakarta','1979-02-13','MARIMIN','Klaten','1952-10-23','Jatinom','1979-01-01','Guru SLTA','SMA negeri Jatinom','130701386','-','80','26.900 - 21.520','3','0','II/b','Sarmud.STO th.1977','Kepala Badan Administrasi Kepegawaian Negara','II. 34256239','1978-12-28','2013-07-03','P'),('CPNS1','KLATEN','2013-08-02','AGUSTINUS DWI B.D','KLATEN','1992-08-01','KLATEN','2013-08-03','DOSEN','UNIVERSITAS NEGRI YOGYAKARTA','105314031','105314031001','80','100000','3','0','III/b','SARMUD S.KOM','BAPAKNYA','1088421','2013-08-16','2013-07-10','P');
...
insert  into `sk_karpeg`(`id_SuratKarpeg`,`nip_lama`,`nip_baru`,`nama_pemilik`,`tanggal_lahir`,`tmt_cpns`,`tanggal_penyimpanan_surat`,`kode_operator`) values ('C. 0085821','130701386','-','MARIMIN,BA','1952-10-23','1979-01-01','2013-07-08','P');
...
CREATE TABLE `sk_pangkatterakhir` (
  ...
  `masa_kerja_golongan` varchar(10) DEFAULT NULL,
...
insert  into `sk_pangkatterakhir`(`id_SuratPangkatTerakhir`,`nama_pemilik`,`tanggal_lahir`,`nip_lama`,`nip_baru`,`pendidikan`,`pangkat_lama`,`golongan_lama`,`tmt_lama`,`pangkat_baru`,`golongan_baru`,`tmt_baru`,`masa_kerja_golongan`,`gaji_pokok`,`masa_kerja_golongan_bulan`,`tanggal_penyimpanan_surat`,`kode_operator`,`Profesi`,`Sekolah`) values ('823.4/72/2002','Drs. MARIMIN','1952-10-23','130701388','-','S1/D4','penata Tk 1','III /','2002-10-01','Pembina','IV /a','2002-10-01','31','1122400','7','2013-07-05','P','Guru SLTA','SMA negeri Jatinom'),('SPT1','AGUSTINUS DWI B.D','1992-08-01','105314031','105314031001','123','123','123','2013-07-05','ASD','ASD','2013-07-05','5','1000000','1','2013-07-10','P','DOSEN','UNIVERSITAS NEGRI YOGYAKARTA');
