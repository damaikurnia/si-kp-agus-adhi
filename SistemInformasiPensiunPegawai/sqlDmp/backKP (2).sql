...
insert  into `anggotakeluarga`(`nik`,`nama_lengkap`,`jenis_kelamin`,`tempat_lahir`,`tanggal_lahir`,`agama`,`pendidikan`,`pekerjaan`,`status_perkawinan`,`status_hub_keluarga`,`kewarganegaraan`,`no_paspor`,`no_kitas_kitap`,`nama_ayah`,`nama_ibu`) values ('332010200','Widayati','P','Klaten','1961-08-14','Islam','S1','PNS','kawin','Istri','Indonesia','-','-','Rudi','Yeni'),('333000201000020','Drs. Marimin','L','Klaten','1952-10-23','ISlam','S1','Guru','kawin','Suami','Indonesia','-','-','Darmo','Ida');
...
insert  into `operator`(`idPegawai`,`passwordpegawai`) values ('1234','1234');
