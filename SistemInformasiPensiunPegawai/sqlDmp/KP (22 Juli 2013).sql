...
insert  into `kk`(`id_Suratkk`,`nama_kk`,`Alamat`,`RT`,`RW`,`Kelurahan_Desa`,`Kecamatan`,`Kabupaten_Kota`,`kode_pos`,`provinsi`,`tanggal_penyimpanan_surat`,`kode_operator`) values ('0012999222','Drs.Marimin','Dukuh Topeng,Desa kajen,Kecamatan Ceper','-','-','Kajen','Ceper','Klaten','57422','Jawa tengah','2013-07-12','P');
...
insert  into `sk_pangkatterakhir`(`id_SuratPangkatTerakhir`,`nama_pemilik`,`tanggal_lahir`,`nip_lama`,`nip_baru`,`pendidikan`,`pangkat_lama`,`golongan_lama`,`tmt_lama`,`pangkat_baru`,`golongan_baru`,`tmt_baru`,`masa_kerja_golongan`,`gaji_pokok`,`masa_kerja_golongan_bulan`,`tanggal_penyimpanan_surat`,`kode_operator`,`Profesi`,`Sekolah`,`tempat_lahir`) values ('823.4/72/2002','Drs. MARIMIN','1952-10-23','130701388','-','S1/D4','penata Tk 1','III /','2002-10-01','Pembina','IV /a','2002-10-01','31','1122400','7','2013-07-05','P','Guru SLTA','SMA negeri Jatinom','Klaten');
